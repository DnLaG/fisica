...
class menu(tk.Frame):
    ...
    def __init__(self, master=None):  # Master es la ventana y self es el frame
        ...
        self.config(bg="#bfbfbf", width=self.propiedades.default_size_ancho,
                    height=self.propiedades.default_size_alto)  # Medidas iniciales de la ventana + Color de fondo
